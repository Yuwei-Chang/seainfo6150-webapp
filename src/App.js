...
const author = <h4>Kate Farley</h4>;
const date = <h4>November 22, 2018</h4>;
const article = 
                <div>
                  <article>
                  <body>
                    ...
                    <p>
                        <q><i>Although it is not one of the most difficult things we have ever moved,</i></q>says Douglas Phelps, who oversaw the relocation of the torch, <q>it is certainly the most important.</q>
                    </p>
                    ...
                    <p>
                        <q><i>The original torch is a beautiful object of art and exemplifies the American ideals of freedom and democracy,</i></q> says John Piltzecker, superintendent of the Statue of Liberty National Monument. That symbolic spirit was bolstered by the decision to inscribe Emma Lazarus' poem <q><b>The New Colossus</b></q> on the statue's pedestal, which gave Lady Liberty one of her nicknames,<q><b>Mother of Exiles.</b></q>
                    </p>
